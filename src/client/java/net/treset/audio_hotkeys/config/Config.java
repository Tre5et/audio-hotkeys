...
public class Config {
    ...
    public static final KeybindConfig OPEN_CONFIG = new KeybindConfig(new int[]{InputConstants.KEY_H /*O*/}, 0, 10, "config.audiohotkeys.open_config", "config.audiohotkeys.open_config.comment");
